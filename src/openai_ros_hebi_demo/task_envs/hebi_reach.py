...
from openai_ros_hebi_demo.robot_envs import hebi
...
class HebiReachEnv(hebi.HebiEnv, utils.EzPickle):
    def __init__(self):
        ...
        ros_ws_abspath = rospy.get_param("/hebi/ros_ws_abspath", None)
        ...
        super(HebiReachEnv, self).__init__(ros_ws_abspath)

        rospy.logdebug("Entered HebiEnv Env")
        self.get_params()
    ...
    def get_params(self):
        ...
        self.n_actions = 1 # rospy.get_param('/fetch/n_actions')
